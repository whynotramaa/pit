- [x] Implement garbage collection for objects as each new updates makes new folder - so if hash is not in the index being used then we can remove it safely !
